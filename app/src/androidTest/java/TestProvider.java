...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        // FinancialDataProvider class.
        ComponentName componentName = new ComponentName(mContext.getPackageName(),
                FinancialDataProvider.class.getName());
        try {
            ...
            assertEquals("Error: FinancialDataProvider registered with authority: " + providerInfo.authority +
            ...
            assertTrue("Error: FinancialDataProvider not registered at " + mContext.getPackageName(),
                    false);
        }
    }
    ...
    public void testGetType() {
        ...
        String type = mContext.getContentResolver().getType(DataContract.StocksEntry.CONTENT_URI);
...
//        type = mContext.getContentResolver().getType(
//                DataContract.StocksEntry.buildWeatherLocationWithDate(testLocation, testDate));
...
////        SqlLiteDbHelper dbHelper = new WeatherDbHelper(mContext);
////        SQLiteDatabase db = dbHelper.getWritableDatabase();
////
