...
public class StockCursorAdapter extends RecyclerView.Adapter<StockCursorAdapter.StockHolder>{

    private List<Stock> mStockList;
    private Context mContext;

    public StockCursorAdapter(Context context, List<Stock> stockList) {
        mContext=context;
